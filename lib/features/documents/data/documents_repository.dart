...
abstract class DocumentsRepository {
  ...
  Future<List<DocumentModel>> uploadDocument(String documentId);
}

class MockDocumentsRepository implements DocumentsRepository {
  const MockDocumentsRepository();

  static final List<DocumentModel> _documents = AppData.user.documents??[];
  // [
  ...
  @override
  Future<List<DocumentModel>> uploadDocument(String documentId) async {
