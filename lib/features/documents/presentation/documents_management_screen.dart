    ...
    return BlocConsumer<DocumentsCubit, DocumentsState>(
      ...
      builder: (context, state) {
        ...
        final documents = switch (state) {
          ...
          _ => const <DocumentModel>[],
        };

        final uploadingId =
            state is DocumentsUploading ? state.documentId : null;
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        Widget buildCard(DocumentModel document, {required bool compact}) {
          final uploading = uploadingDocumentId == document.documentId;
          return DocumentCard(
            document: document,
            compact: compact,
            uploading: uploading,
            ...
            onReplace: (document.uploadedAt?.isNotEmpty ?? false)
